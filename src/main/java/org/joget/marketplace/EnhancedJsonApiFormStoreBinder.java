...
public class EnhancedJsonApiFormStoreBinder extends FormBinder implements FormStoreBinder, FormStoreElementBinder, FormStoreMultiRowElementBinder {
    ...
    public String getName() {
        return "Enhanced JSON API Form Store Binder";
    }
    ...
    public String getDescription() {
        return "Default JSON API Form Store Binder with additional ability to follow system proxy settings, support API token, customise socket timeout retries.";
    }
    ...
    public String getPropertyOptions() {
        ...
        String json = AppUtil.readPluginResource(getClass().getName(), "/properties/enhancedJsonApiFormStoreBinder.json", arguments, true, MESSAGE_PATH);
        return json;
    }
