...
public class EnhancedJsonApiFormOptionsBinder extends FormBinder implements FormLoadOptionsBinder, FormAjaxOptionsBinder {

    private final static String MESSAGE_PATH = "messages/enhancedJsonApi";

    @Override
    public String getName() {
        return "Enhanced JSON API Form Options Binder";
    }
    ...
    public String getDescription() {
        return "Default JSON API Form Options Binder with additional ability to follow system proxy settings, support API token, customise socket timeout retries.";
    }
    ...
    //     return AppUtil.readPluginResource(getClass().getName(), "/properties/enhancedJsonApiFormOptionsBinder.json", new String[]{useAjax}, true, null);
    // }
    ...
    public String getPropertyOptions() {
        ...
        String json = AppUtil.readPluginResource(getClass().getName(), "/properties/enhancedJsonApiFormOptionsBinder.json", arguments, true, MESSAGE_PATH);
        return json;
    }
